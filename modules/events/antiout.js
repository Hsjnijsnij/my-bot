...
const path = join(__dirname, "cache", "antiout","randomgif");
  ...
  api.addUserToGroup(event.logMessageData.leftParticipantFbId, event.threadID, (error, info) => {
   if (error) {
    api.sendMessage({body: `[ 𝗔𝗡𝗧𝗜𝗢𝗨𝗧 ] \n*☄️  ★ * ° .✩° 🪐｡ ✨ . ☆ •°.🌎⠀\n 𝐊𝐡𝐨̂𝐧𝐠 𝐭𝐡𝐞̂̉ 𝐭𝐡𝐞̂𝐦 𝐥𝐚̣𝐢 𝐜𝐨𝐧 𝐚̂𝐦 𝐛𝐢𝐧𝐡 𝐧𝐚̀𝐲 ${name} 𝐯𝐚̀𝐨 𝐧𝐡𝐨́𝐦 \n[ 𝐓𝐡𝐨̛̀𝐢 𝐆𝐢𝐚𝐧 ] ➣ ${timeNow} `, attachment: createReadStream(gifPath) },event.threadID)
   } else api.sendMessage({body:`[ 𝗔𝗡𝗧𝗜𝗢𝗨𝗧 ] \n*☄️  ★ * ° .✩° 🪐｡ ✨ . ☆ •°.🌎⠀\n 𝐀𝐝𝐮𝐮𝐮 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐲𝐞̂𝐮 ${name} 𝐜𝐮̉𝐚 𝐭𝐚𝐨 𝐯𝐮̛̀𝐚 𝐭𝐡𝐨𝐚́𝐭 𝐤𝐡𝐨̉𝐢 𝐧𝐡𝐨́𝐦 𝐧𝐡𝐮̛𝐧𝐠 𝐤𝐡𝐨̂𝐧𝐠 𝐭𝐡𝐨𝐚́𝐭 𝐤𝐡𝐨̉𝐢 𝐭𝐚𝐲 𝐚𝐧𝐡 ! \n*☄️  ★ * ° .✩° 🪐｡ ✨ . ☆ •°.🌎⠀\n『 𝐓𝐡𝐨̛̀𝐢 𝐆𝐢𝐚𝐧 』➣ ${timeNow} `,attachment: createReadStream(gifhh) }, event.threadID);
  })
 }
}